...
public class ShapeParser
{
    ...
    private CircleParams ParseCircleParams( string[] unparsedParams )
    {
    ...
    private TriangleParams ParseTriangleParams( string[] unparsedParams )
    {
    ...
    private LineParams ParseLineParams( string[] unparsedParams )
    {
    ...
    private TextParams ParseTextParams( string[] unparsedParams )
    {
