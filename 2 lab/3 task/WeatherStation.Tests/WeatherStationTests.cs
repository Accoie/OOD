...
public class WeatherStationTests
{
    ...
    public void NotifyObservers_CallsUpdate_InPriorityOrder()
    {
        ...
        highMock.Setup( x => x.Update( It.IsAny<WeatherInfo>() ) ).Callback( () => callOrder.Add( "high" ) );
        mediumMock.Setup( x => x.Update( It.IsAny<WeatherInfo>() ) ).Callback( () => callOrder.Add( "medium" ) );
        lowMock.Setup( x => x.Update( It.IsAny<WeatherInfo>() ) ).Callback( () => callOrder.Add( "low" ) );
    ...
    public void RegisterObserver_PreventsDuplicateRegistration()
    {
        ...
        observerMock.Verify( x => x.Update( It.IsAny<WeatherInfo>() ), Times.Once );
    }
}